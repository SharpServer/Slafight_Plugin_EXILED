...
public static class CandyChanges
{
    ...
    private static void SpecialCandiesEffect(EatenScp330EventArgs ev)
    {
        ...
        if (ev.Candy.Kind == CandyKindID.Black)
        {
            ...
            ev.Player?.ShowRueiPlus("<size=24>この世全ての混沌を混ぜて煮詰めた匂いがする...</size>");
        }
        ...
        else if (ev.Candy.Kind == CandyKindID.Gray)
        {
            ...
            ev.Player?.ShowRueiPlus("<size=24>埃っぽく鉄臭い匂いが鼻を刺す...</size>");
        ...
        {
            ev.Player?.ShowRueiPlus("<size=24>眩しいほどに爽やかなオレンジの匂いがする...</size>");
        ...
        else if (ev.Candy.Kind == CandyKindID.White)
        {
            ...
            ev.Player?.ShowRueiPlus("<size=24>透き通るようなミルクの香りがする...</size>");
        }
        else if (ev.Candy.Kind == CandyKindID.Evil)
        {
            ...
            Timing.CallDelayed(1f, () =>
            {
                ...
                ev.Player?.ShowRueiPlus("<size=24>冒涜的な匂いに気が狂いそうになる...</size>");
            });
        }
    }
}
