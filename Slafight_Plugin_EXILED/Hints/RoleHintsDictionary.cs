...
internal static class RoleHintsDictionary
{
        ...
        new Dictionary<CRoleTypeId, (string, string, string)>
    {
        ...
        [CRoleTypeId.LwsJudgement]   = ($"<color={ServerColors.Silver}>MTF Omega-1: Judgement</color>",   FoundTeam + " - " + GoCTeam, OmegaObj),
        [CRoleTypeId.LwsLiaison]     = ($"<color={ServerColors.Silver}>MTF Omega-1: Liaison</color>",     FoundTeam + " - " + GoCTeam, OmegaObj),
        [CRoleTypeId.LwsForensic]    = ($"<color={ServerColors.Silver}>MTF Omega-1: Forensic</color>",    FoundTeam + " - " + GoCTeam, OmegaObj),
        [CRoleTypeId.LwsAgent]       = ($"<color={ServerColors.Silver}>MTF Omega-1: Agent</color>",       FoundTeam + " - " + GoCTeam, OmegaObj),
        [CRoleTypeId.RrhWarden]      = ($"<color={ServerColors.Red}>MTF Alpha-1: Warden</color>",      FoundTeam, AlphaObj),
        [CRoleTypeId.RrhEnforcer]    = ($"<color={ServerColors.Red}>MTF Alpha-1: Enforcer</color>",    FoundTeam, AlphaObj),
        [CRoleTypeId.RrhAegis]       = ($"<color={ServerColors.Red}>MTF Alpha-1: Aegis</color>",       FoundTeam, AlphaObj),
        [CRoleTypeId.RrhAssaulter]   = ($"<color={ServerColors.Red}>MTF Alpha-1: Assaulter</color>",   FoundTeam, AlphaObj),
