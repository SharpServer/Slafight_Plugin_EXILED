...
public class Scp610Role : CRole
{
    ...
    protected override void OnRoleHurtingOthers(HurtingEventArgs ev)
    {
        ...
        {
            ev.Attacker.ShowRueiPlus("<size=22><color=yellow><b>相手を感染させる事に成功した！3分後には同胞になっているであろう！</b></color></size>", 5);
            ev.Player.ShowRueiPlus("<size=22><color=red><b>SCP-610に感染してしまった！\nSCP-500で治療しなければ三分後には同胞になってしまうぞ！");
        ...
        {
            ev.Amount /= 10f;
            ev.Attacker.ShowRueiPlus("<size=24>相手はもうすでに感染しています！</size>");
        }
    }
