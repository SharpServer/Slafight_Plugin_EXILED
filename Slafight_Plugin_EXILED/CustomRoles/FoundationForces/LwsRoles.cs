...
{
    protected override string RoleName { get; set; } = "<color=#7ddcff>Law's Left Hand: Judgement</color>";
...
{
    protected override string RoleName { get; set; } = "<color=#7ddcff>Law's Left Hand: Liaison</color>";
...
{
    protected override string RoleName { get; set; } = "<color=#7ddcff>Law's Left Hand: Forensic</color>";
...
{
    protected override string RoleName { get; set; } = "<color=#7ddcff>Law's Left Hand: Agent</color>";
